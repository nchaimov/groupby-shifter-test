...
#SBATCH -t 00:30:00
#SBATCH -J GroupBy1W
#SBATCH -e GroupBy1W-%j.err
#SBATCH -o GroupBy1W-%j.out
...
export SPARK_CONF_DIR="/global/homes/n/nchaimov/groupby-shifter-test/conf-1w"
...
while [ $CUR_NUM_NODES -le $NUM_NODES ] ; do
    ...
    shifter $SPARK_HOME/bin/spark-submit --master spark://$MASTER:7077 $SPARK_HOME/instrumentation-benchmarks/GroupBy/target/scala-2.11/groupbytest_2.11-1.0.jar $NUM_PARTITIONS $KVP_PER_PARTITION $VALUE_BYTES $NUM_PARTITIONS $SEED
